                    ...
                    <dx:PanelContent>
                        <div class="LogoPane">
                            <a class="LogoLink" href="Default.aspx">
                                <dx:ASPxImage runat="server" ID="LogoImage" ImageUrl="~/Content/Images/Icons/307x46.svg" Width="204px" Height="30px" ShowLoadingImage="true"></dx:ASPxImage>
                            </a>
                        </div>
                        <div class="SidePane">
                            ...
                            <tr>
                                <td class="ActionMenuContainer">
                                    <dx:ASPxMenu runat="server" ID="ActionMenu" CssClass="ActionMenu" Width="100%" ItemAutoWidth="false" 
                                        AppearAfter="9999999" ClientSideEvents-ItemClick="App.onActionMenuItemClick"

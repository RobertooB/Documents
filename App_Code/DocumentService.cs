...
public class DocumentService : ServiceBase {
    ...
    public DevExpress.XtraPrinting.IBasePrintable CreatePrintableComponent(Item documentItem) {
    ...
    public void ValidateCurrentDocumentExists() {
...
public abstract class DocumentManagerBase {
    ...
    public virtual DevExpress.XtraPrinting.IBasePrintable CreatePrintableComponent(Item fileItem) {
        return null;
    }
}
...
public class RichEditDocumentManager : StandardDocumentManagerBase<DevExpress.XtraRichEdit.DocumentFormat> {
    ...
    public override DevExpress.XtraPrinting.IBasePrintable CreatePrintableComponent(Item fileItem) {

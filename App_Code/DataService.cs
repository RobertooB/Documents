...
public class DemoDataInitializer : CreateDatabaseIfNotExists<DocumentsDb> {
    ...
    User[] CreateUsers(DocumentsDb context) {
        ...
        string susAvatarPath = Path.Combine(UsersPath, "Amogus Sus.jpg");
        ...
        User[] users = new User[] {
            ...
            new User { AccountName = "Amogus", Name = "Amogus Sus", Avatar = CreateBinaryContent(context, susAvatarPath) }
        };

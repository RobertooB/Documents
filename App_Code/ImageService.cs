...
public class AvatarService : ServiceBase {
    protected const string AvatarFolderVirtPath = @"~\Content\Images\Avatars";
...
public class ThumbnailService : ServiceBase {
    protected const string ThumbnailFolderVirtPath = @"~\Content\Images\Thumb";
    ...
    void GenerateThumbnailCore(Item item) {
        IBasePrintable component = DocumentService.CreatePrintableComponent(item);
        if(component == null)
            return;
